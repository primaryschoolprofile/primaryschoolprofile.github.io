...
function slogan(heading, subheading, badge="") {
  return `
    <div class="bg-secondary text-white text-center"><h1>` + heading + `</h1><h5>` + subheading + `</h5><span class="m-2 badge badge-success"><h3>` + badge + `</h3></span></span></div>
  `
}
...
$(function(){
  ...
  $(".index").html(`
    <div class="container">
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-md-3 py-4 text-center">` + logo(
  ...
  $(".website").html(`
    <div class="container">
      <div class="py-4 text-center">
        <img class="w-100" src="https://www.easyman.hk/wp-content/uploads/2019/12/website_banner-1024x293.jpg">
      </div>
      <div class="py-4">
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-lg-3 py-3">` + 
            ...
            point("1 Facebook 基本頁面建立及連結", file) + 
            point("1 製作文章及發佈培訓（1 小時）", file) + 
            point("3 個產品/服務類別", cart) + 
            point("10 個產品相片整理及內容輸入", cart) + 
            point("1 個網上收款 Paypal (Visa/Master) 戶口設立及收款頁面", cart) + 
            point("1 個基礎送貨頁面", cart) + 
            point("1 次產品更新內容及價格、加減產品培訓（1 小時）", cart) + `
          </div>
        </div>
      </div>
    </div>
