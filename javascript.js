...
function gen_html_all(options, index){
  ...
  if (options[index].length > 3){
    result = "<span class='pr-2 text-primary' onclick='select_all(this)'>全選</span><span class='pr-2 text-primary' onclick='clear_all(this)'>清除</span>"
  }
  return result
}
